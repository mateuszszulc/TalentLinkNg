...
$('#btnAdd').click(function() {
    $.ajax({
        type: 'GET',
        url: "http://localhost:8080/wine/tanieWino",
        dataType: 'json',
...
$('#btnSave').click(function() {
    $.ajax({
        ...
        url: "http://localhost:8080/wine/pets",
        dataType: "json",
        data: wineToJSON(),
        ...
        error: function(jqXHR, textStatus, errorThrown){
            alert('Nie udalo sie dodac. error: ' + textStatus);
        }
    });
});

function wineToJSON() {
    //{"name":"Bla","staffName":["mkyong1","mkyong2"]}
    return JSON.stringify({
        "name": "WinoMarkiWino",
        "staffName": ["Dziala","Yeah!!!"]
    });
}
